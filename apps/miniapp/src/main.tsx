...
type Profile = { name: string; avatar_url: string | null; honors: { farm_level: number; highest_pet_tier: number; crafted_cards: number }; privacy: { farm_public: boolean; collection_public: boolean } };
